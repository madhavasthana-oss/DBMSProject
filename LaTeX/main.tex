...
\input{SchemaAndNormalization/tables.tex}
...
\input{DDL/listings.tex}

\section{SQL Queries}

\subsection{Basic Queries}

\input{SQLQueries/Basic/allBooksWIthAuthor.tex}

\input{SQLQueries/Basic/activeCarts.tex}

\input{SQLQueries/Basic/totalStock.tex}

\subsection{Complex Queries}

\input{SQLQueries/Complex/availableStock.tex}

\input{SQLQueries/Complex/cartSummary.tex}

\input{SQLQueries/Complex/revenuePerPublisher.tex}
...
\input{PLSQL/procedures/addToCart.tex}

\input{PLSQL/procedures/checkout.tex}

\subsection{Triggers}

\input{PLSQL/triggers/summary.tex}

\input{PLSQL/triggers/triggerDecrement.tex}
